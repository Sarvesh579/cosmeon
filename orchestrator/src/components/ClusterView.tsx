      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
        <div>
          <h1 className="text-5xl font-black text-white tracking-tighter mb-2">
            STORAGE <span className="text-accent underline decoration-white/10 underline-offset-8">CLUSTER</span>
          </h1>
        ...
        <div className="flex items-center gap-4 glass-panel px-6 py-3 rounded-2xl border-white/10">
          <div className="text-right">
            ...
            <p className="text-xl font-bold text-white tracking-tighter">{data.nodes.length} ONLINE NODES</p>
          </div>
